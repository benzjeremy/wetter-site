...
"$BUILD_TOOLS/apksigner" sign \
    ...
    --out "$DIR/wetter-v1.0.apk" \
    "$WORK/aligned.apk"

echo "==> 8. Verifying APK signature..."
"$BUILD_TOOLS/apksigner" verify --verbose "$DIR/wetter-v1.0.apk"

echo "✅ SUCCESS! Native Android Wetter App APK built at: $DIR/wetter-v1.0.apk"
